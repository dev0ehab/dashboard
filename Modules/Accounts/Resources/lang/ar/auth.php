...
return [
    ...
    */
    ...
    'validations' => [
        ...
        'deleted' => '. تم حذف هذا الحساب , يرجي التواصل مع الادارة',
    ...
    'messages' => [
        ...
        'notification' => 'تم تغيير حالة الاشعارات بنجاح',
    ...
    'notifications' => [
        ...
        'create-auth-model' => [
            'subject' => 'لقد تم إنشاء حسابك بنجاح',
            'greeting' => 'عزيزي :user',
            'line' => 'يمكنك الان تسجيل الدخول',
            'password' => ":password كلمة المرور الخاصة بك",
            'footer' => 'شكراً لاستخدامك لتطبيقنا',
            'salutation' => 'مع تحيات فريق عمل :app',
        ],
