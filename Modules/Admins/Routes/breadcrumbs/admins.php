...
Breadcrumbs::for('dashboard.admins.index', function ($breadcrumb) {
    ...
    $breadcrumb->push(trans('admins::admins.plural'), route('dashboard.admins.index'));
});

Breadcrumbs::for('dashboard.admins.create', function ($breadcrumb) {
    $breadcrumb->parent('dashboard.admins.index');
    $breadcrumb->push(trans('admins::admins.actions.create'), route('dashboard.admins.create'));
});
...
Breadcrumbs::for('dashboard.admins.edit', function ($breadcrumb, $admin) {
    ...
    $breadcrumb->push(trans('admins::admins.actions.edit'), route('dashboard.admins.edit', $admin));
});
