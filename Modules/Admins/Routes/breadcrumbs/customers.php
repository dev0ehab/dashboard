...
Breadcrumbs::for('dashboard.customers.index', function ($breadcrumb) {
    ...
    $breadcrumb->push(trans('admins::customers.plural'), route('dashboard.customers.index'));
});

Breadcrumbs::for('dashboard.customers.create', function ($breadcrumb) {
    $breadcrumb->parent('dashboard.customers.index');
    $breadcrumb->push(trans('admins::customers.actions.create'), route('dashboard.customers.create'));
});
...
Breadcrumbs::for('dashboard.customers.edit', function ($breadcrumb, $customer) {
    ...
    $breadcrumb->push(trans('admins::customers.actions.edit'), route('dashboard.customers.edit', $customer));
});
